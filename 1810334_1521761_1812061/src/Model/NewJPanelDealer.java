...
public class NewJPanelDealer extends JPanel {
	...
	Jogador player;
	private JButton JButtonQuit = new JButton("Deal");
	private JButton JButtonClear = new JButton("Hit");
	private JButton JButtonSave = new JButton("Split");
	private JLabel JLabelPrizePool = new JLabel("Aposta total = 0");
	
	public NewJPanelDealer() 
	{
